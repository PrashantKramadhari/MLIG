...
def load_mesh(
    ...
    with path.open("r") as f:
        mesh = load_obj(f)
    vertices = torch.tensor(mesh['geometry']['data/stanford_bunny.obj']["vertices"], dtype=torch.float32, device=device)# added recently ['geometry']['data/stanford_bunny.obj']
    faces = torch.tensor(mesh['geometry']['data/stanford_bunny.obj']["faces"], dtype=torch.int64, device=device)
